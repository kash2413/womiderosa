...
var persistComputedStylesAndRect = (function() {
  ...
  return function (node) {
    ...
    if (node.nodeName === 'IMG' || node.nodeName === 'SVG' || node.nodeName === 'IFRAME') {
...
var pfMod = window.pfMod || (function(window, undef) {
  ...
  var utils = {
    ...
    isDynamicPage: function() {
      return !!window.React || // https://reactjs.org/
             !!window.ko || // https://knockoutjs.com/
             !!window.Polymer || // https://www.polymer-project.org
             !!window.m || // https://mithril.js.org
             !!window.angular || // https://angularjs.org/
             (!!window.ng && !!window.ng.coreTokens) || // https://angular.io/
             !!window.Backbone || // http://backbonejs.org/
             !!window.Ember || // https://www.emberjs.com/
             !!window.Vue || // https://vuejs.org/
             (
               // https://www.meteor.com/
               // http://svelte.technology
               !!document.querySelector &&
               !!document.querySelector('[ng-version],[data-reactroot],[data-bind],[class*="svelte-"],.__meteor-css__')
             );
    },
  ...
  var pf = {
    ...
    setVariables: function() {
      ...
      var js = {
        ...
        core: "https://cdn.printfriendly.com/assets/client/core-07d05b98f1c3739b37c30efeea1456d9d0b4fdddb0a8cba36d9b63f81f49eddc.js",
        algo: "https://cdn.printfriendly.com/assets/client/algo-014b1e364764bdca09762e33c5bd756d07270b4bd92d918fccf827aab8673c3a.js"
      };
    ...
    skipRedirectReasons: [
      {
        ...
        name: 'ApiButtonOrExtensionRedirectFalse',
        check: function() {
          var isBookmarklet = utils.isBookmarklet();
          return !isBookmarklet && !pf.dsData.domain_settings.redirect;
        }
      }, {
        name: 'BMExt',
        check: function() {
    ...
    forceRedirectReasons: [
      {
        ...
        check: function() {
          ...
          return pf.config.domains.page.match(/yahoo\.com|techcrunch\.com/);
        }
      }
    ],
    ...
    runRedirectChecks: function() {
      ...
      var skipRedirectReason = this.runChecksFor(this.skipRedirectReasons);
      if (!skipRedirectReason) {
        return { redirect: true };
      }

      var forceRedirectReason = this.runChecksFor(this.forceRedirectReasons);
      if (forceRedirectReason) {
        return { reason: forceRedirectReason.name, redirect: true };
      }
      this.__redirectChecksResult = { reason: skipRedirectReason.name, redirect: false };
  ...
  var twitter = {
    copyEmbeded: function() {
      ...
      elements = doc.querySelectorAll('twitter-widget.twitter-tweet-rendered');
      for (i = elements.length - 1; i >= 0; i--) {
        element = elements[i];
        messageBus.postMessage('core', 'PfTwitterWidgetShadowDom', {
          id: element.id,
      ...
      elements = doc.querySelectorAll('iframe.twitter-tweet-rendered, .twitter-tweet-rendered iframe');
      for (i = elements.length - 1; i >= 0; i--) {
        elements = elements[i];
        messageBus.postMessage('core', 'PfTwitterTweetRendered', {
          id: element.id,
          head: element.contentDocument.head.innerHTML,
          body: element.contentDocument.body.innerHTML,
          cssText: element.style.cssText
        });
      }
    }
          ...
          if (sourceChild.nodeType === Node.ELEMENT_NODE) {
            try {
              ...
              if (nodeName === 'a') {
                ...
                sourceChild.src = sourceChild.src;
                var srcset = sourceChild.getAttribute('srcset');
                if (srcset) {
